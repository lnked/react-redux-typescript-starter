...
const scanImage = async (image: Image, scanner?: ImageScanner): Promise<Array<Symbol>> => {
...
export const scanImageData = async (image: ImageData, scanner?: ImageScanner): Promise<Array<Symbol>> => {
