...
module.exports = {
  // setupFiles: ['<rootDir>/configs/jest/shim.js', '<rootDir>/configs/jest/jest.setup.js'],
  ...
  transform: {
    '^(?!.*\\.(jsx?|tsx?|json|css|less|styl|s(a|c)?ss)$)': '<rootDir>/configs/jest/fileTransformer.js',
    '\\.(jsx?)$': '<rootDir>/node_modules/babel-jest',
    '\\.(tsx?)$': '<rootDir>/node_modules/ts-jest',
    // '\\.(tsx?)$': 'ts-jest'
    // '\\.(tsx?)$': '<rootDir>/configs/jest/tsPreprocessor.js'
